...
<header>
    ...
    <div class="middle-menu center-text"><a href="#" class="logo"><img src="images_demo/logo.png" alt="Logo Image"></a></div>
...
<div class="main-slider">
    <div id="slider">
        ...
        <div class="ls-slide" data-ls="bgsize:cover; bgposition:50% 50%; duration:4000; transition2d:104; kenburnsscale:1.00;">
            <img src="images_demo/slider-1-1600x800.jpg" class="ls-bg" alt="" />
        ...
        <div class="ls-slide" data-ls="bgsize:cover; bgposition:50% 50%; duration:4000; transition2d:104; kenburnsscale:1.00;">
            <img src="images_demo/slider-2-1600x800.jpg" class="ls-bg" alt="" />
            ...
            <div class="col-lg-8 col-md-12">
                <div class="blog-posts">
                    ...
                    <div class="single-post">
                        <div class="image-wrapper"><img src="images_demo/blog-1-1000x600.jpg" alt="Blog Image"></div>
                    ...
                    <div class="single-post">
                        <div class="image-wrapper"><img src="images_demo/blog-2-1000x600.jpg" alt="Blog Image"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="single-post">
                                <div class="image-wrapper"><img src="images_demo/blog-3-500x400.jpg" alt="Blog Image"></div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="single-post">
                                <div class="image-wrapper"><img src="images_demo/blog-4-500x400.jpg" alt="Blog Image"></div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="single-post">
                                <div class="image-wrapper"><img src="images_demo/blog-5-500x400.jpg" alt="Blog Image"></div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="single-post">
                                <div class="image-wrapper"><img src="images_demo/blog-6-500x400.jpg" alt="Blog Image"></div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="single-post post-style-2">
                                <div class="image-wrapper width-50 left-area">
                                    <img src="images_demo/blog-7-500x400.jpg" alt="Blog Image"></div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="sidebar-area">
                    ...
                    <div class="sidebar-section about-author center-text">
                        <div class="author-image"><img src="images_demo/author-1-200x200.jpg" alt="Autohr Image"></div>
                        ...
                        <div class="signature-image"><img src="images_demo/signature-image.png" alt="Signature Image"></div>
                    ...
                    <div class="sidebar-section category-area">
                        ...
                        <a class="category" href="#">
                            <img src="images_demo/category-1-400x150.jpg" alt="Category Image">
                            <h6 class="name">TRAVEL</h6>
                        </a>

                        <a class="category" href="#">
                            <img src="images_demo/category-2-400x150.jpg" alt="Category Image">
                            <h6 class="name">FASHION</h6>
                        </a>

                        <a class="category" href="#">
                            <img src="images_demo/category-3-400x150.jpg" alt="Category Image">
                            <h6 class="name">LIFESTYLE</h6>
                        </a>
                        <a class="category" href="#">
                            <img src="images_demo/category-4-400x150.jpg" alt="Category Image">
                    ...
                    <div class="sidebar-section latest-post-area">
                        ...
                        <div class="latest-post" href="#">
                            <div class="l-post-image"><img src="images_demo/recent-post-1-150x200.jpg" alt="Category Image"></div>
                            <div class="post-info">
                        ...
                        <div class="latest-post" href="#">
                            <div class="l-post-image"><img src="images_demo/recent-post-2-150x200.jpg" alt="Category Image"></div>
                            <div class="post-info">
                                <a class="btn category-btn" href="#">TRAVEL</a>
                        ...
                        <div class="latest-post" href="#">
                            <div class="l-post-image"><img src="images_demo/recent-post-3-150x200.jpg" alt="Category Image"></div>
                            <div class="post-info">
                                <a class="btn category-btn" href="#">TRAVEL</a>
                        ...
                        <div class="latest-post" href="#">
                            <div class="l-post-image"><img src="images_demo/recent-post-4-150x200.jpg" alt="Category Image"></div>
                            <div class="post-info">
                                <a class="btn category-btn" href="#">TRAVEL</a>
                    ...
                    <div class="sidebar-section advertisement-area">
                        ...
                        <a class="advertisement-img" href="#">
                            <img src="images_demo/advertise-1-400x500.jpg" alt="Advertisement Image">
                    ...
                    <div class="sidebar-section instagram-area">
                        ...
                        <ul class="instagram-img">
                            <li><a href="#"><img src="images_demo/instragram-side-1-150x150.jpg" alt="Instagram Image"></a></li>
                            <li><a href="#"><img src="images_demo/instragram-side-2-150x150.jpg" alt="Instagram Image"></a></li>
                            <li><a href="#"><img src="images_demo/instragram-side-3-150x150.jpg" alt="Instagram Image"></a></li>
                            <div class="clearfix"></div>
                            <li><a href="#"><img src="images_demo/instragram-side-4-150x150.jpg" alt="Instagram Image"></a></li>
                            <li><a href="#"><img src="images_demo/instragram-side-5-150x150.jpg" alt="Instagram Image"></a></li>
                            <li><a href="#"><img src="images_demo/instragram-side-6-150x150.jpg" alt="Instagram Image"></a></li>
                        </ul>
